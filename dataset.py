...
class DataModel:
    ...
    def __init__(self, df_1: DataFrame, df_2: DataFrame):
        self.df_1 = df_1
        self.df_2 = df_2
    ...
    def clean_all_df(self):
        ...
        Löscht reihe wo alle werte NAN sind (pandas.dropna)
        """
    ...
    def crunch_all_df(self):
        ...
        self.df_changes = self.df_changes[self.df_changes["_merge"] == "right_only"]
